...
```sh
node scripts/report-locale.mjs assets/report-examples/decision-ko.json > /tmp/report-locale-decision-ko-a4.html
node scripts/report-locale.mjs assets/report-examples/reference-en.json > /tmp/report-locale-reference-en-letter.html
```
